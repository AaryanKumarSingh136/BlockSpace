...
export default function SignUpPage() {
  ...
  return (
    <main className="relative min-h-screen flex items-center justify-center bg-[#07090e] text-white p-4 sm:p-6 overflow-hidden">
      {/* Background Orbs */}
      <div className="absolute top-1/3 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[550px] h-[550px] bg-indigo-600/15 rounded-full blur-[150px] pointer-events-none" />
      <div className="absolute bottom-10 left-10 w-[350px] h-[350px] bg-cyan-600/15 rounded-full blur-[120px] pointer-events-none" />
        ...
        <div className="glass-panel rounded-3xl p-6 sm:p-8 shadow-2xl border border-white/10 relative overflow-hidden">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="space-y-2">
              ...
              <p className="text-[11px] text-gray-500">Minimum 6 characters with letters & numbers</p>
            </div>
            ...
            {successMsg && (
              <div className="p-3.5 bg-emerald-500/10 border border-emerald-500/30 rounded-xl animate-in fade-in duration-200 flex items-center gap-2">
                ...
                <p className="text-emerald-300 text-xs font-medium leading-relaxed">{successMsg}</p>
              </div>
            )}
          ...
          <div className="mt-6 pt-6 border-t border-white/10 text-center">
            <p className="text-xs text-gray-400">
              Already registered?{' '}
              <Link href="/sign-in" className="text-indigo-400 font-bold hover:text-indigo-300 transition">
                Sign in now
              </Link>
            </p>
          </div>
